...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/baka_juice_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695392d4c369cd49b17c540d',
      shopName: 'BAKA JUICE',
...
app.listen(PORT, () => {
  console.log(`BAKA JUICE Backend Server running on port ${PORT}`);
});
